...
function Footer() {
  return (
    <div className="footer flex flex-1 flex-col-reverse text-xs text-stone-400">
      <div className="mx-auto flex items-center gap-1">
        <span className="italic">心诚则灵</span>
        <a
          target="_blank"
          href="https://github.com/sunls24/divination"
          className="flex items-center gap-1 rounded p-1 transition-colors hover:bg-stone-200"
        >
          <svg
            width="512"
            height="512"
